 ...
 *
 * @param {string} - the name of the PDR, used when throwing a PDRParsingError
...
function parseSpec(pdrName, spec) {
  ...
  if (checksumType || checksumValue) {
    ...
    if ((checksumType === 'CKSUM') && (typeof checksumValue !== 'number')) {
      throw new PDRParsingError(`Expected CKSUM value to be a number: ${checksumValue}`);
    }
    if ((checksumType === 'MD5') && (typeof checksumValue !== 'string')) {
